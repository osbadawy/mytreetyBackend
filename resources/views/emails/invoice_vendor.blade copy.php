                            ...
                            <tr>
                                <td style="align-content: center;">
                                    <p style="font-size: 30px; margin: 0">
                                        Sie haben eine Bestellung! (You have an order!)
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <p style="font-size: 14px; color: #707070">
                                        Bitte versenden Sie die Bestellung innerhalb von 5 Werktagen. Wenn es irgendwelche Probleme gibt, kontaktieren Sie bitte vendor@mytreety.com (Please dispatch the order within 5 business days. If there are any issues please contact vendor@mytreety.com)
                                    </p>
                                </td>
                            </tr>
                        </table>
                                        ...
                                        <tr>
                                            <td style="text-align: left">
                                                ...
                                                <p style="display: inline-block; font-size: 16px; font-weight: bold">
                                                    Bestellungsbestätigung (Order confirmation)
                                                </p>
                                            </td>
                                        </tr>
                                    </table>
                                        ...
                                        <tr>
                                            <td style="text-align: left;">
                                                <p style="font-weight: bold; font-size:12px; ">
                                                    Bestellnummer (Order number): <br> {{ $order->code }} </p>
                                                    <p style="font-weight: bold; font-size:12px; ">
                                                    Bestelldatum (Order date): <br> {{ date('d-m-Y', $order->date) }}</p>
                                                <table>
                                                        @php
                                                        ...
                                                        @endphp
                                                    <tr>
                                                        <td style="text-align: left;">Ausgewählte Wohltätigkeitsorganisation:</td>
                                                        <td><img src="{{ uploaded_asset($charity->user->avatar_original) }}"
                                                                style="max-width: 45px;" alt=""></td>
                                                    </tr>

                                                    <!-- <tr>
                                                        <td style="text-align: left;">Umwelt Wohltätigkeitsorganisation:</td>
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <p
                                                                style="margin: auto 16px auto 50px; text-align: left; font-size: 12px; font-weight: bold">
                                                                Versand nach (Order to):
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <p
                                                                style="margin-left: 50px; margin-right: 16px; text-align: left;">
