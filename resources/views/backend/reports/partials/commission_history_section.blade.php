    ...
    <table class="table aiz-table mb-0">
        <thead>
            <tr>
                ...
                <th>{{ translate('Mytreety Commission') }}</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $history->payment_status == 1 ? 'Paid' : 'Pending' }}</td>
                <td>&euro; {{ $history->admin_commission }}</td>
                <td><a href="{{route('vendor.invoice.download',$history->order->id)}}">{{translate('Download')}}</a></td>
