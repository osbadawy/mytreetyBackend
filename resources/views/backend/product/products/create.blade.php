                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control aiz-selectpicker" name="sustainabilities[]"
                                    id="sustainabilities" data-live-search="true" multiple required>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            @if (get_setting('shipping_type') == 'product_wise_shipping')
                                ...
                                {{-- <div class="form-group row">
                            <label class="col-md-6 col-from-label">{{translate('Table Rate')}}</label>
                            <div class="col-md-6">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="radio" name="table_type" value="flat_rate">
                                    <span></span>
                                </label>
                            </div>
                        </div> --}}
