        ...
        <div class="row align-items-center">
            ...
            @if ($type != 'Seller')
                <div class="col text-right">
                    ...
                    <a href="{{ route('product_bulk_export.index') }}" class="btn btn-circle btn-warning">
                        <span>{{ translate('CSV Export') }}</span>
                    </a>
                </div>
                        ...
                        @foreach ($products as $key => $product)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <strong>{{ translate('Sustainability') }}:</strong>Level
                                    {{ $product->sustainability_rank }} </br>
                            ...
                            <label class="aiz-switch aiz-switch-success mb-0">
                                ...
                                <td class="text-right">
                                    <a class="btn btn-soft-success btn-icon btn-circle btn-sm"
                                        href="{{ env('FRONTEND_URL') }}/products/{{ $product->slug }}" target="_blank"
