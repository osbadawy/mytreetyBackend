...
<!--                <div class="card">
            ...
            <div class="col-lg-4">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{translate('Sustainability')}}</h5>
                    </div>
                    <div class="card-body">
                        <label for="name">
                            {{translate('Sustainability Ranking')}}
                        </label>
                        <br>
                        @for ($i = 1; $i < $product->sustainability_rank; $i++)
                            <img src="{{ url('/public/assets/img/rank-1.png') }}" alt="{{translate('Image')}}" class="rank-image">
                        @endfor
                      <br><br>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <label for="name">
                                {{translate('Choose Sustainability')}}
                            </label>
                            <select class="form-control aiz-selectpicker" name="sustainabilities[]" id="sustainabilities" data-live-search="true" multiple required>
                                @foreach ($sustainabilities as $sustainability)

                                    <option value="{{ $sustainability->id }}" >


                                    {{ $sustainability->getTranslation('name') }}
                                    {{-- <img src="{{ uploaded_asset($sustainability->image) }}" alt="{{translate('Image')}}" style="width: 5px"> --}}
                            ...
                            {{-- {{ $sustainability->getTranslation('name') }} --}}
                            <img src="{{ uploaded_asset($sustainability->getTranslation('image')) }}" alt="{{translate('Image')}}" class="h-50px" title="{{$sustainability->getTranslation('name') }}">
