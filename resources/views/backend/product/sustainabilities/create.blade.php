...
<div class="row">
    <div class="col-lg-8 mx-auto">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('sustainabilities.store') }}" method="POST" enctype="multipart/form-data">
                	@csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="weight" value="1" class="form-control" id="weight" placeholder="{{translate('weight')}}" required>
                        </div>
                    </div>
