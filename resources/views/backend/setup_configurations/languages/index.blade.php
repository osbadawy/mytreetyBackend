...
<div class="aiz-titlebar text-left mt-2 mb-3">
	<div class="align-items-center">
		<div class="text-md-right">
            <a href="{{ route('translations.fix') }}" class="btn btn-circle btn-warning">
				<span>{{translate('Fix Static Translations')}}</span>
			</a>
            <a href="{{ route('productstranslations.fix') }}" class="btn btn-circle btn-warning">
				<span>{{translate('Fix products Translations')}}</span>
			</a>
