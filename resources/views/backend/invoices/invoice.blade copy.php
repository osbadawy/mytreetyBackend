	...
	<div>
		...
		<div style="background: #EEF5E5;padding: 1rem;">
			<table>
				<tr>
					...
					<td style="font-size: 1.5rem;" class="text-right strong">{{  translate('Order Confirmation') }}</td>
				</tr>
			</table>
			<table>
				<tr>
		...
		<div style="padding: 1rem;padding-bottom: 0">
            <table>
				...
				@endphp
				<tr><td class="strong small gry-color">{{ translate('Order Confirmation') }}:</td></tr>
        ...
        <footer class="footer">
            <div >
                This e-mail is only an acknowledgement of receipt of your order. Your contract to purchase these items is not complete until we send you an e-mail notifying you that the items have been dispatched (attaching their respective tracking information). Please do not reply to this message.<br>
