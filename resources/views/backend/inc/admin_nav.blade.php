        ...
        <div class="d-flex justify-content-around align-items-center align-items-stretch">
            ...
            <div class="d-flex justify-content-around align-items-center align-items-stretch ml-3">
                <div class="aiz-topbar-item">
                    ...
                    &nbsp; &nbsp;
                    <div class="d-flex align-items-center">
                        <a class="btn btn-soft-warning btn-sm d-flex align-items-center" href="{{ route('refresh.products.cache')}}">
                            <i class="las la-sync fs-20"></i>
                            <span class="fw-500 ml-1 mr-0 d-none d-md-block">{{ translate('Refresh Products Cache') }}</span>
                        </a>

                    </div>
                    &nbsp; &nbsp;
                    <div class="d-flex align-items-center">
                        <a class="btn btn-soft-primary btn-sm d-flex align-items-center" href="{{ route('refresh.products.ranking')}}">
                            <i class="las la-sync fs-20"></i>
                            <span class="fw-500 ml-1 mr-0 d-none d-md-block">{{ translate('Refresh Products Ranking') }}</span>
                        </a>

                    </div>
                    &nbsp; &nbsp;
                    <div class="d-flex align-items-center">
                        <a class="btn btn-soft-secondary btn-sm d-flex align-items-center" href="{{ route('refresh.products.publish')}}">
                            <i class="las la-sync fs-20"></i>
                            <span class="fw-500 ml-1 mr-0 d-none d-md-block">{{ translate('Refresh Products Publish') }}</span>
                        </a>
