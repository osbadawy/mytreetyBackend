            ...
            <div class="col-md-4 ml-auto">
                <table>
                    <tbody>
                        ...
                        <tr>
                            <td class="text-main text-bold">{{translate('Referral Code')}}</td>
                            <td class="text-right">@if($order->referral_code){{  $order->referral_code }} @else - @endif</td>
                        </tr>
                    </tbody>
                </table>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @elseif ($orderDetail->product != null)
