...
<!--                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#exampleModal">
            ...
            <div class="col-lg-2">
                <div class="form-group mb-0">
                    <input type="text" class="aiz-date-range form-control" value="{{ $referral_code }}" name="referral_code" placeholder="{{ translate('Filter by referral code') }}"  autocomplete="off">
                </div>
            </div>
            <div class="col-lg-2">
                <div class="form-group mb-0">
